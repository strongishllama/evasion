...
//  Date Created:   23rd September 2016
...
public class BaseGuard_90 : MonoBehaviour
{
	/// <summary>
	...
	{
		m_Colors[0].r = 0.1323529f;
		m_Colors[0].g = 3.0f;
		m_Colors[0].b = 3.0f;
	}

	/// <summary>
	/// private void : Set yellow color.
	/// </summary>
	...
	public void SetStartColors()
	{
		SetYellowColor();
		SetBlueColor();
		m_BaseGuardRenderer.sharedMaterial.SetColor("_EmissionColor", m_Colors[1]);
		m_ExitSign.sharedMaterial.SetColor("_EmissionColor", m_Colors[0]);
		for (int iCount = 0; iCount < m_Lights.Length; ++iCount)
		{
			m_Lights[iCount].color = m_Colors[1];
		}
	}
